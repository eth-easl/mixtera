...
class LocalStub(MixteraClient):
    ...
    def add_property(
        ...
        return self._mdc.add_property(property_name,setup_func,calc_func, execution_mode, property_type, min_val=min_val, max_val=max_val, num_buckets=num_buckets, batch_size=batch_size, dop=dop, data_only_on_primary=data_only_on_primary)
    ...
    def _get_query_result(self, training_id: str) -> QueryResult:
        if wait_for_key_in_dict(self._training_query_map, training_id, 60.0):
