...
from mixtera.core.query import ArbitraryMixture, Query, StaticMixture, MixtureKey
...
def test_reproducibility(
    ...
    mixture = StaticMixture(query_exec_args.mixture.chunk_size, {MixtureKey({"language": ["JavaScript"]}): 0.6, MixtureKey({"language": ["HTML"]}): 0.4},)
    result_list = []
