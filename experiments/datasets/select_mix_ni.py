...
def select(args):
    ...
    category_selection = {
        ...
        "Commonsense Classification": 0.5,
...
if __name__=="__main__":
    ...
    parser.add_argument("--train-jsonl", type=str, default=".cache/datasets/prepared/ni_train.jsonl")
    parser.add_argument("--portion", type=float, default=0.1)
    parser.add_argument("--output-jsonl", type=str, default=".cache/datasets/prepared/ni_train_selected.jsonl")
